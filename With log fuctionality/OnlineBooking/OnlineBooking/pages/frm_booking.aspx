                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <div class="ddType" id="booking-details">
                                    ...
                                    <asp:DropDownList ID="dd_booking" runat="server" DataSourceID="SqlDataSource2" DataTextField="booking_type" DataValueField="booking_type_id" AutoPostBack="True"></asp:DropDownList>
                                    ...
                                    <asp:DropDownList ID="dd_team" runat="server"  AutoPostBack="True" DataSourceID="ObjectDataSource1" DataTextField="team_title" DataValueField="team_category_id"></asp:DropDownList>
                                ...
                                <div id="timeslots">
                                       <asp:GridView ID="grd_Booking" runat="server" CssClass="form-control" OnRowCommand="grd_Booking_RowCommand" OnRowDataBound="grd_Booking_RowDataBound" EnableViewState="False" AutoGenerateColumns="False" HeaderStyle-BackColor="Silver" DataSourceID="ObjectDataSource4" CellPadding="0" DataKeyNames="schedule_id">
                                        <Columns>
                                            ...
                                            <asp:CheckBoxField DataField="is_confirmed" HeaderText="is_confirmed" SortExpression="is_confirmed" Visible="false"></asp:CheckBoxField>
                                            ...
                                            <asp:CommandField ShowSelectButton="True" ButtonType="Button" SelectText="Select" ControlStyle-CssClass="btn btn-gradient-success" />
                                        </Columns>
                                    </asp:GridView>
