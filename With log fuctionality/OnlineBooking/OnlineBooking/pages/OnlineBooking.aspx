                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div id="timeslots">
                                    ...
                                    <div>
                                        <asp:GridView ID="grd_additional_ch" runat="server" CssClass="form-control" EnableViewState="False" AutoGenerateColumns="False" DataKeyNames="additional_ch_id" DataSourceID="ObjectDataSource8" HeaderStyle-BackColor="Silver">
                                            <Columns>
